...
export default {
  ...
  data () {
    return {
      ...
      fields: [
        ...
        {
          key: 'employee_name', label: 'Employee Name', sortable: true, class: 'text-center'
        },
        {
          key: 'employee_salary', label: 'Employee Salary', sortable: true, image: true
        },
        {
  ...
  methods: {
    loadPassengers () {
      ...
      employeeService.getListEmployees(this.params).then((response) => {
        if (response.data) {
